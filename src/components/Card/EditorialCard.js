                  ...
                  <div className="overflow-hidden w-full">
                      ...
                      <div className="bg-zinc-700/10 h-11 rounded-r-lg rounded-t-none">
                          <div className="flex flex-row w-full justify-between items-center px-2">
                            {props.chunk1 && <p className="text-sm text-gray-400 inline-block py-4 p-2">
                                <span className="rounded-full bg-green-500 w-2 h-2 inline-block mr-1"></span>{props.chunk1}
                            </p>}
                            {props.chunk2 && <p className="text-sm text-gray-400 inline-block p-2 flex items-center">
                                <span className="rounded-full bg-gray-500 w-2 h-2 inline-block mr-1"></span>{props.chunk2}
                            </p>}
                            {props.chunk3 && <p className="text-sm text-gray-400 inline-block p-2 flex items-center">
                                <span className="rounded-full bg-blue-500 w-2 h-2 inline-block mr-1"></span>{props.chunk3}
                            </p>}
                          </div>
                      </div>
                  </div>
